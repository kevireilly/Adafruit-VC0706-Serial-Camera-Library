...
class ParticleTTLCamera {
 public:
  // Constructor when using ParticleSoftSerial
  ParticleTTLCamera(ParticleSoftSerial *ser);
  // Constructor when using USARTSerial
  ParticleTTLCamera(USARTSerial *ser);
